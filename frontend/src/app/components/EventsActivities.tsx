        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {pastEvents.map((event) => (
              <div
                key={event.id}
                className="bg-white dark:bg-zinc-900 rounded-lg overflow-hidden opacity-75 hover:opacity-100 transition-opacity duration-300 shadow-lg dark:shadow-none"
              >
                <div className="relative h-48 w-full">
                  <Image
                    src={event.image}
