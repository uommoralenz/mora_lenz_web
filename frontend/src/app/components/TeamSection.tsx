...
const teamMembers: { name: string; position: string; about: string; imageUrl: string; order?: Block[]; size?: "sm" | "md" | "lg" }[] = [
  {
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex justify-center">
          <h3 className="mt-14 mb-6 text-2xl md:text-3xl font-semibold tracking-wide text-gray-100 relative inline-block">
            ...
            <span className="absolute left-1/2 -bottom-2 w-24 h-[2px] -translate-x-1/2
            bg-gradient-to-r from-transparent via-sky-400 to-transparent"></span>
          </h3>
        </div>
          ...
          {executiveRows.map((row, rowIndex) => (
            <div
              ...
              className={[
                ...
                row.cols === 2 ? "grid-cols-1 sm:grid-cols-2 max-w-2xl mx-auto" :
                row.cols === 3 ? "grid-cols-1 sm:grid-cols-3 max-w-4xl mx-auto" :
